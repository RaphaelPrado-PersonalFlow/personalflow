...
const initialStudents: Student[] = [
  { id: 1, name: "João Mendes", phone: "(21) 99911-2200", email: "joao@email.com", cpf: "123.456.789-00", goal: "Hipertrofia", frequency: 92, status: "Ativo", lastSession: "Ontem", daysWithoutTraining: 1, nextSession: "Hoje, 14:00", initials: "JM", reevaluationPending: false, observations: "" },
  { id: 2, name: "Mariana Costa", phone: "(21) 99832-4411", email: "mariana@email.com", cpf: "234.567.890-11", goal: "Emagrecimento", frequency: 88, status: "Ativo", lastSession: "20/07", daysWithoutTraining: 8, nextSession: "Amanhã, 08:30", initials: "MC", reevaluationPending: true, observations: "" },
  { id: 3, name: "Carlos Lima", phone: "(21) 99745-8830", email: "carlos@email.com", cpf: "345.678.901-22", goal: "Condicionamento", frequency: 76, status: "Ativo", lastSession: "18/07", daysWithoutTraining: 10, nextSession: "Sexta, 10:00", initials: "CL", reevaluationPending: false, observations: "" },
  { id: 4, name: "Ana Souza", phone: "(21) 99654-1192", email: "ana@email.com", cpf: "456.789.012-33", goal: "Força", frequency: 95, status: "Ativo", lastSession: "Hoje", daysWithoutTraining: 0, nextSession: "Quinta, 14:00", initials: "AS", reevaluationPending: true, observations: "" },
  { id: 5, name: "Paulo Rocha", phone: "(21) 99512-7001", email: "paulo@email.com", cpf: "567.890.123-44", goal: "Qualidade de vida", frequency: 64, status: "Pausado", lastSession: "10/07", daysWithoutTraining: 18, nextSession: "Não agendado", initials: "PR", reevaluationPending: true, observations: "" },
  { id: 6, name: "Beatriz Alves", phone: "(21) 99420-3366", email: "beatriz@email.com", cpf: "678.901.234-55", goal: "Hipertrofia", frequency: 84, status: "Ativo", lastSession: "21/07", daysWithoutTraining: 7, nextSession: "Hoje, 18:00", initials: "BA", reevaluationPending: false, observations: "" },
];
...
export default function StudentsPage() {
  ...
  function addStudent(event: FormEvent<HTMLFormElement>) {
    ...
    setStudents((current) => [{ id: Date.now(), name, phone, email, cpf, goal, status: "Ativo", frequency: 100, lastSession: "Ainda não treinou", daysWithoutTraining: 0, nextSession: "Não agendado", initials: getInitials(name), reevaluationPending: false, observations: "" }, ...current]);
