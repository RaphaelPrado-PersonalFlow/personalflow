      ...
      <div className="space-y-7">
        ...
        <section className="space-y-4">
          {filteredProtocols.map((protocol) => {
            ...
            const protocolVolume = volumeByMuscle(protocol.workouts, volumeMetric);
            const maximumProtocolVolume = Math.max(...protocolVolume.map((item) => item.value), 1);
            const totalProtocolVolume = protocolVolume.reduce((total, item) => total + item.value, 0);
